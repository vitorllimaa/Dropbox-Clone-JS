...
class DropBoxController {
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyCsW7HSL38CZu9_FpzJT3XL7GGkyd0hmPU",
    authDomain: "dropboxclone14.firebaseapp.com",
    databaseURL: "https://dropboxclone14-default-rtdb.firebaseio.com",
    projectId: "dropboxclone14",
    storageBucket: "dropboxclone14.appspot.com",
    messagingSenderId: "598123646832",
    appId: "1:598123646832:web:16eeb1f5fcf51f888a89b5",
    measurementId: "G-LKML3V5PYE"
  };
  // Initialize Firebase
...
removeTask(){
    ...
    this.getSelection().forEach(li=>{
        ...
        promises.push(this.ajax((resolver, reject)=>{
    ...
    ajax(url, method = 'GET', formData = new FormData(), onprogress = function(){}, onloadstart =
    function(){} ){
    ...
    readFiles(){
        ...
        this.getFireBaseRef().on('value', snapshot =>{
         ...
         snapshot.forEach(snaphotItem =>{

            let key = snaphotItem.key;
            let data = snaphotItem.val();
            ...
            if(e.shiftKey){
                ...
                if (firstLi){
                    ...
                    lis.forEach((el, index)=>{
                        ...
                        if(firstLi === el) indexStrat = index;
                    ...
                    let index = [indexStrat, indexEnd].sort();
